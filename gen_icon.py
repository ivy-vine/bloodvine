...
def generate_icon(image_path, textures_path, team, threshold, out_path, size):
...
generate_icon(args.filepath, "resources/textures", args.team, args.threshold, out_path, args.size)